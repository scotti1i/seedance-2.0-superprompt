...
⭐ [GitHub 加星](https://github.com/scotti1i/seedance-2.0-superprompt) · 📚 [方法论](seedance/methodology.md) · 🧩 [模板库](seedance/templates/INDEX.md) · 🇬🇧 [English](README.md)
...
> [Issues](https://github.com/scotti1i/seedance-2.0-superprompt/issues)。
